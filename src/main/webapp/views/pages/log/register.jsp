        ...
        <main>          
            <div class="container">
                <div class="inner-wrap p-5 mt-5 card text-dark mx-auto">
                    <form action="<c:url value="/register"/>" id="reg" method="POST">  
                        ...
                        <p class="fw-bold fs-2 text-center">Register</p>
                        <div class="mb-3">
                        ...
                        <div class="mb-4">
                            <label for="exampleConfirmPassword1" class="form-label"
                        ...
                        <div class="row justify-content-end">
                           <div class="col-3"><div class="text-end">
                               <button type="submit" class="btn btn-log-in btn-primary mt-3  text-dark"><a href="../log/log-in.jsp" class="text-dark">Log in</a></button></div></div>
                            <div class="col-3"><div class="text-end">
                               <button  value="register" name="action" type="submit" class="btn btn-primary mt-3">Submit</button></div></div>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="containrt-fluid">
                <div class="row w-100">
                    <div class="col-xl-2 mr-5 logo-cus">
                        <div class="img">
                            <img src="./assets/images/logo.jpg" alt="" class="img-fluid rounded mb-3" style="width: 100px; margin-left: 30%;">
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-12 col-12 icon-cus">
                        ...
                        <a href="https://www.facebook.com/profile.php?id=100024445011384">
                            <i class="fa-brands fa-facebook d-inline-block"></i></a>
