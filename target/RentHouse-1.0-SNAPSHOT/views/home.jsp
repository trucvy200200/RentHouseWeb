                ...
                <div class="container h-100">
                    <div class="row h-100">
                         <c:forEach var="item" items="${list}">
                                    <div class="col-md-3 my-3 "> <!-- devide our row into 4 columns-->
                                    <div class="card w-100" style="width: 30%;">
                                        <img class="card-img-top" src="<c:url value='./views/assets/images/${item.image}'/>" alt="Card image cap">
                                        <div class="card-body">
                                            <h5 class="card-title">${item.title}</h5>
                                            <h6 class="price">Price :${item.description} </h6>
                                            <h6 class="category">Category :${item.cost} </h6>
                                        </div>
                                    </div>
                                </div>
                        </c:forEach>
